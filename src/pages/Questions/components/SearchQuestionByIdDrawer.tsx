...
interface ExistingFormInterface {
  ...
  primaryButtonCallBack: (ques: IMcqQuestionPopulated) => void;
}
const SearchQuestionByIdDrawer: React.FC<ExistingFormInterface> = ({
  setScreen,
  prevMcqsId,
    ...
    <>
      <div className="flex flex-row gap-6 items-center justify-center ">
        <div className="w-full ">
          ...
          <div className="flex items-center  w-full flex-col md:flex-row space-y-4 md:space-y-0">
            <div className="w-full ">
              <Input
                type="text"
            ...
            <div className="w-full md:w-52 md:ml-4 flex-shrink-0">
              <ButtonFill
                handleClick={() => {
                  findQuestion();
                }}
        ...
        {questionData && (
          <div className="w-52 ml-4">
            <ButtonFill
              width="w-full"
              handleClick={() => {
                primaryButtonCallBack(questionData);
              }}
              disabled={
                !questionId ||
                questionId.trim() === '' ||
...
export default SearchQuestionByIdDrawer;
